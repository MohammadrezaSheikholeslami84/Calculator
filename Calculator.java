...
public class Calculator implements ActionListener{
    ...
    JButton[] MainFuctionButtons = new JButton[4];
    JButton[] AdditionalFunctionButtons = new JButton[4];
    JButton addButton,subButton,mulButton,divButton;
    JButton decButton, equButton, delButton, clrButton, negButton ,sqrtButton, logarithmButton,factorialButton,powButton;
    JPanel panel;
    ...
    Calculator(){
        ...
        MainFuctionButtons[0] = addButton;
        MainFuctionButtons[1] = subButton;
        MainFuctionButtons[2] = mulButton;
        MainFuctionButtons[3] = divButton;
        ...
        for(int i =0;i<4;i++) {
            MainFuctionButtons[i].addActionListener(this);
            MainFuctionButtons[i].setBackground(new Color(145,72,22));
            MainFuctionButtons[i].setForeground(Color.WHITE);
            MainFuctionButtons[i].setFont(myFont);
            MainFuctionButtons[i].setBorder(BorderFactory.createLineBorder(new Color(115,57,18)));
            MainFuctionButtons[i].setFocusable(false);
        }
        ...
        negButton.setBounds(50,550,100,50);
        delButton.setBounds(156,550,100,50);
